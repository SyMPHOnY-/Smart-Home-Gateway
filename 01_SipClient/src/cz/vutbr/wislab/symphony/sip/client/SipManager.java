...
//import org.knopflerfish.bundle.event.EventAdminService;
...
import cz.vutbr.wislab.symphony.sip.util.Activator;
...
public class SipManager implements SipListener, SipManagerInterface {
	...
	Timer timer;
	Request messageAuth; // request before proxy authorisation
	...
	private void initialize() {
		...
		// A1 is set to proxy-registration (there exist otbound proxy)
